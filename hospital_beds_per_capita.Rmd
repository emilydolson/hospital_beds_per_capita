...
Okay, some caveats: not all of these beds are intended for emergency infectious disease use. Some of them are in psych or maternity hospitals, for instance. Also, some are already in use at any given time. Also counties aren't necessarily the best geographic unit to be using here. They're weirdly shaped and don't necessarily reflect the locations people would go in an emergency. In an ideal world I would come up with some rolling mean across space of number of people vs. number of hospital beds within some radius. This is just intended to give a quick impression of regions that may be at increased risk of running out of hospital beds/quantify the extent to which that varies. Note also that I'm not an epidemiologist or a public health expert, so there could well be nuances here that I'm unaware of.
